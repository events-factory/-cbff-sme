...
export default function Footer() {
  ...
  const navLinks = [
    ...
    { href: "/architecture", label: navT.architecture },
    { href: "/program",      label: navT.program },
    { href: "/partners",     label: navT.partners },
    { href: "/sponsorship",  label: navT.sponsor },
    { href: "/register",     label: navT.register },
  ];
